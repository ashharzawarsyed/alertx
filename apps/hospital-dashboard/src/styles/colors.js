...
export const colors = {
  ...
  gradients: {
    ...
    background: 'linear-gradient(135deg, #3b82f6 0%, #1e40af 35%, #0ea5e9 100%)', // Multi-stop blue gradient
    card: 'linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.85) 100%)',
    cardDark: 'linear-gradient(135deg, rgba(30, 41, 59, 0.95) 0%, rgba(51, 65, 85, 0.9) 100%)',
    sidebar: 'linear-gradient(135deg, rgba(15, 23, 42, 0.98) 0%, rgba(30, 41, 59, 0.95) 100%)',
