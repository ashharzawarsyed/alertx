          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-1">
                  Manage incoming emergency requests and coordinate patient
                  admissions
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="px-4 py-2 bg-red-500/20 text-red-300 rounded-xl text-sm font-bold border border-red-500/30 shadow-lg shadow-red-500/20">
                {
                  filteredEmergencies.filter((e) => e.status === "pending")
                    .length
                }{" "}
                Pending
              </span>
        ...
        {filteredEmergencies.length === 0 ? (
          ...
          <div className="space-y-6">
            {filteredEmergencies.map((emergency) => (
              <div key={emergency.id} className="relative group">
                <div
                ...
                ></div>
                <div
                  className={`relative bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-xl rounded-2xl shadow-xl border-2 ${
                    emergency.priority === "critical"
                      ...
                      <div className="text-right">
                        ...
                        {emergency.estimatedResponseTime && (
                          <div className="flex items-center gap-2 text-sm text-blue-400 font-bold bg-blue-500/10 px-3 py-1.5 rounded-lg border border-blue-500/30">
                            ...
                            <span>
                              ETA: {emergency.estimatedResponseTime} mins
                            </span>
                          </div>
                        )}
                      </div>
                  ...
                  <div className="space-y-4">
                    <label className="block">
                      ...
                      >
                        ...
                        <option value="icu" className="bg-gray-800">
                          ICU ({hospitalData?.availableBeds?.icu || 0}{" "}
                          available)
                        </option>
                    ...
                    <div className="p-4 bg-blue-500/10 rounded-xl border border-blue-500/30">
                      ...
                      <p className="text-sm text-blue-300">
                        <strong className="text-blue-200">Condition:</strong>{" "}
                        {selectedEmergency.condition}
                      </p>
                    </div>
                  </div>
                </div>
