    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="text-center">
          ...
          <p className="text-gray-300 text-lg font-medium">Loading hospital profile...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 px-8 py-8">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-blue-100 text-xl font-medium">{hospitalData.type}</p>
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {hospitalData.location?.lat && hospitalData.location?.lng && (
              ...
              <div className="flex items-start gap-3 p-5 bg-gray-700/30 rounded-xl border border-gray-600/30 hover:border-green-500/30 transition-all">
                ...
                />
                <div>
                  <p className="text-sm text-gray-400 uppercase tracking-wide">Contact Number</p>
                  <p className="text-white font-semibold mt-1">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="p-4 border border-slate-200 rounded-lg">
                <p className="text-sm text-gray-400 mb-1 uppercase tracking-wide">General Beds</p>
              ...
              <div className="p-4 border border-slate-200 rounded-lg">
                <p className="text-sm text-gray-400 mb-1 uppercase tracking-wide">ICU Beds</p>
                <p className="text-3xl font-bold text-white">
                  {hospitalData.totalBeds?.icu || 0}
                </p>
                <p className="text-xs text-green-600 mt-1">
              ...
              <div className="p-4 border border-slate-200 rounded-lg">
                <p className="text-sm text-gray-400 mb-1 uppercase tracking-wide">Emergency Beds</p>
                <p className="text-3xl font-bold text-white">
                  {hospitalData.totalBeds?.emergency || 0}
                </p>
                <p className="text-xs text-green-600 mt-1">
          ...
          <div className="pt-6 border-t border-gray-700/50">
            <div className="flex items-center justify-between text-sm text-gray-400">
              <span className="flex items-center gap-2">
                ...
                Created: {new Date(hospitalData.createdAt).toLocaleDateString()}
              </span>
              <span className="flex items-center gap-2">
                Last updated:{" "}
