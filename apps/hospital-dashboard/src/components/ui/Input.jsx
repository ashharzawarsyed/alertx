...
const inputStyles = {
  ...
  // Medical theme
  medical:
    "glass border-green-300/50 focus:border-green-500 focus:ring-green-500/50",
  ...
  // Success state
  success:
    "bg-green-50 border-green-300 focus:border-green-500 focus:ring-green-500/50",
};
...
export const Input = forwardRef(
  (
    ...
    const baseClasses =
      "block w-full rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed placeholder-gray-400";
...
export const Textarea = forwardRef(
  (
    ...
    const baseClasses =
      "block w-full px-4 py-3 rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed placeholder-gray-400 resize-none";
...
export const Select = forwardRef(
  (
    ...
    const baseClasses =
      "block w-full rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed appearance-none bg-no-repeat bg-right bg-select-arrow";
