...
const cardVariants = {
  ...
  success:
    "bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-200 shadow-card",
  warning:
    "bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 shadow-card",
  danger:
    "bg-gradient-to-br from-red-50 to-pink-50 border border-red-200 shadow-card",
